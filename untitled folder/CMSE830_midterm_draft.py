...
with tab4:
    ...
    #st.pyplot(sns.boxplot(df['avg_salary'], x='avg_salary'))
    #if st.checkbox('Select if you plan to be more than an averge Datat Scientist'):
        #st.pyplot(sns.violinplot(data=df, y='Avg_Salary', x='Title Simplified'))
